   ...
   <span style="color: rgb(127, 127, 127);">
      <span style="color: rgb(89, 89, 89); font-size: 15px;">
         <span data-custom-class="body_text">
            ...
            <bdt class="question noTranslate">__________</bdt>
            <bdt class="block-component"></bdt>
            </bdt> (
            <bdt class="block-component"></bdt>
         ...
         <span style="font-size: 15px; color: rgb(89, 89, 89);">
            <span data-custom-class="body_text">
               ...
               <span style="color: rgb(0, 58, 250);">
                  <bdt class="question noTranslate"><a href="https://totalboardom.co.uk" target="_blank" data-custom-class="link">https://totalboardom.co.uk</a></bdt>
               </span>
               <span style="font-size: 15px;">
                  <span style="color: rgb(89, 89, 89);">
                     <span data-custom-class="body_text">
...
<ul>
   <li data-custom-class="body_text" style="line-height: 1.5;">
      <span style="font-size: 15px;">
         Use 
         <bdt class="question">Total Boardom - Kanban AI</bdt>
         . 
         <bdt class="question">A Kanban tool for prompts. Break your project down into easy to manage prompts.</bdt>
      </span>
   ...
   <li data-custom-class="body_text" style="line-height: 1.5;">
      <span style="font-size: 15px;">
         <span data-custom-class="body_text">
            ...
            <bdt class="block-component"></bdt>
            <span style="color: rgb(0, 58, 250);">
               <bdt class="question"><a href="https://www.totalboardom.co.uk/cookie-policy" target="_blank" data-custom-class="link">https://www.totalboardom.co.uk/cookie-policy</a></bdt>
            </span>
            <bdt class="block-component"></bdt>
            .
            <bdt class="statement-end-if-in-editor"></bdt>
...
<div style="line-height: 1.5;">
   <span style="font-size: 15px;">
      <span data-custom-class="body_text">
         ...
         organisation
         <bdt class="else-block"></bdt>
         apart from us. They also commit to pr
      </span>
      <span data-custom-class="body_text">
         otect the data they hold on our behalf and to retain it for the period we instruct. 
         <bdt class="statement-end-if-in-editor"></bdt>
      </span>
      <bdt class="block-component"></bdt>
   </span>
