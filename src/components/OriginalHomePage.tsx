...
export const OriginalHomePage: React.FC = () => {
      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-6 md:px-8 py-12 md:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* CTA Section */}
            <div className="bg-white bg-opacity-15 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-white border-opacity-20 max-w-2xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                Join the Early Access
              </h3>
              <p className="text-lg opacity-90 mb-8">
                Be among the first to experience the future of project management
              </p>
